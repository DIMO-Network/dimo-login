  ...
  return (
    ...
    >
      ...
      <div className="max-w-[480px] text-gray-600 text-sm text-center">
        A physical adapter is required to connect this car to {devLicenseAlias}.
        Device connection is currently only supported inside the DIMO
        Mobile app.
      </div>
      ...
      <div className="flex flex-col w-full max-w-[480px] px-4 space-y-3">
        ...
        <button
          onClick={goBack}
          className="text-gray-500 text-sm hover:text-black mt-2"
        >
          Later
        </button>
      </div>
